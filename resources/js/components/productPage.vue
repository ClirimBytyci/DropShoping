<template>
    <div class="container container-add-clr p-0">
        <div id="carouselMaterialStyle" class="carousel slide carousel-fade carousel-add-clr carousel-add-clr-main"
...
<!--        <div><h1 class="pt-0">Produktet me te kerkuara</h1></div>-->
        <div class="d-block d-sm-none scroll-list-product align-items-center justify-content-center">
            <ul class="me-auto mb-2 mb-lg-0">
<!--                <li class="nav-item m-lg-4 p-3">-->
<!--                    <div class="col-md-6 col-lg-3 pb-4 mb-1 align-items-center justify-content-center">-->
<!--                        <div class="card shadow-lg card-add-clr">-->
<!--                            <div class="d-flex justify-content-between p-3"><p class="lead mb-0">Today's-->
<!--                                Combo Offer</p>-->
<!--                                <div-->
<!--                                    class="bg-info rounded-circle d-flex align-items-center justify-content-center shadow-1-strong"-->
<!--                                    style="width: 35px; height: 35px;"><p class="text-white mb-0 small">-->
<!--                                    x2</p></div>-->
<!--                            </div>-->
<!--                            <div class="heightPhoto"><img-->
<!--                                src="http://dropshoping.ddev.site/images/product/1682203883.download (2).jpeg"-->
<!--                                alt="photo" class="card-img-top" style="cursor: pointer;"></div>-->
<!--                            <div class="card-body">-->
<!--                                <div class="d-flex justify-content-between"><p class="small"-->
<!--                                                                               style="cursor: pointer;"><a-->
<!--                                    class="text-muted">Mobile</a></p>-->
<!--                                    <p class="small text-danger"><s>$1620.00</s></p></div>-->
<!--                                <div class="d-flex justify-content-between mb-3"><h5 class="mb-0"-->
<!--                                                                                     style="cursor: pointer;">-->
<!--                                    Iphone 14 Pro Max-->
<!--                                </h5> <h5 class="text-dark mb-0">$1350.00</h5></div>-->
<!--                                <div class="d-flex justify-content-between mb-2"><p class="text-muted mb-0">-->
<!--                                    Stock: <span class="fw-bold">0</span></p>-->
<!--                                    <div class="ms-auto text-warning"><i class="fas fa-star"></i> <i-->
<!--                                        class="fas fa-star"></i> <i class="fas fa-star"></i> <i-->
<!--                                        class="fas fa-star"></i> <i class="far fa-star"></i></div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <button type="button" disabled="disabled" class="btn btn-success btn-lg">Ska-->
<!--                                Stock-->
<!--                            </button>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                </li>-->
        ...
        <div class="navbar navbar-expand-lg navbar-dark fixed-top bg-light m-0 p-0 nav-bar-add-clr"
             style="left: 0; height: 65px">
            <!-- Container wrapper -->
            <div class="container-fluid">
                ...
                <div class="scroll-list">
                    <ul class="me-auto mb-2 mb-lg-0">
                        <li class="nav-item m-lg-4" v-for="category in categories" :key="category.id"
                            style="cursor: pointer">
                            <a :id="category.id" @click="categoryPage(category.id, category.name)">{{
                                    category.name
                                }}</a>
                        </li>
                    </ul>
                    ...
                    <div class="dropdown" id="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                            <li v-if="name && account.id" style="cursor:pointer;">
                                <a class="dropdown-item" @click="editProfile(name, account.id)">My profile({{
                                        this.name
                                    }})</a>
                            </li>
                            <li v-if="isLogin">
            ...
            <div class="container py-5 py-5-add-clr">
                <div class="row">
                    <div v-for="product in products"
                         class="col-md-6 col-lg-3 mb-4 pl pb-4 align-items-center justify-content-center container-product-add-clr">
                        <div class="card shadow-lg card-add-clr">
                            ...
                            <div v-if="product.media !== null" class="heightPhoto">
                                <img v-if="product.media.url_main" :src="domain+product.media.folder+product.media.url_main"
                                     @click="insideProduct(product.id, product.name, product.product_number)"
                                     style="cursor: pointer"
                                     class="card-img-top" alt="photo"/>
                                <img v-else-if="product.media.url_additional" :src="domain+product.media.folder+JSON.parse(product.media.url_additional)[0]"
                                     @click="insideProduct(product.id, product.name, product.product_number)"
                                     style="cursor: pointer"
                                     class="card-img-top" alt="photo"/>
                            </div>
                            <div v-else class="heightPhoto">
                                <img src="../../../blank.svg"
                                     @click="insideProduct(product.id, product.name, product.product_number)"
                                     style="cursor: pointer"
                                     class="card-img-top" alt="photo"/>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <p style="cursor: pointer" class="small"><a
                                        @click="categoryPage(product.category.id, product.category.name)"
                            ...
                            <button v-if=" Math.floor(product.stock != 0)" type="button" class="btn btn-success btn-lg"
                                    @click="addToCart(product)">Add to Cart
                            </button>
                            <button v-else type="button" disabled class="btn btn-success btn-lg"
                                    @click="addToCart(product)">Ska Stock
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div v-if="showCart == true && cart !== undefined && order !== undefined"
            ...
            <div v-if="payload" v-for="lineItem in payload.line_items" class="card mb-1 vh-25">
                <div class="card-body">
                    <button @click="deleteItem(lineItem.product_id)" type="button" class="btn-close" aria-label="Close" style="left: 100%;position: sticky;"></button>
                    <div class="row">
...
@media (max-width: 575px) {
    ...
    .carousel-add-clr-main {
        margin: 120px 6px auto 6px !important;
    }

    .container-product-add-clr {
        padding-left: 30px;
        padding-right: 30px;
    }
}
...
.scroll-list-product li {
    display: inline-block;
    margin-right: -15px !important;
    vertical-align: middle;
}

.scroll-list-product li:last-child {
    margin-right: 0;
}
